 ...
 * 
 * TODO: Some of these parameters are undocumented. That's kinda intentional:
 * they're redundant. Get rid of them!
 */
 ...
 * 
 * @param {*} id 
 * @returns A String URL to a location. An absolute URL points to a place on
 * the internet; a relative URL points somewhere in the server's assets
 * directory. 
 * 
 * NOTE: we haven't implemented good/evil role images. That on its own
...
function generateSampleToken(id, el) {
  // TODO: this is by definition not used here. 
  // But where else could it be moved?
  el.textContent = "";
